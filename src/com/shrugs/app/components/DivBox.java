...
public class DivBox extends Box {
	...
	/**
	 * Finds the Box which contains the specified point. Should only be called from BodyBox for safety.
	...
	/**
	 * Checks if a specified box overlaps with any children of this box.<br><br>
	 * Usage:
	 * <ul>
	 * <li>Set <b>int</b>s <i>x1, y1</i> on mousedown using mouse coordinates.
	 * <li>Set <b>Box</b> <i>targetBox</i> using <i>youngestBoxContainingPoint(x1, y1)</i> on top level <b>BodyBox</b>. Grab grid snaps, etc.
	 * <li>Set <b>int</b>s <i>x2, y2</i> on mouseup using mouse cordinates. Ensure that <i>youngestBoxContainingPoint(x2, y2) == TargetBox</i>.
	 * <li>Create <b>Box</b> <i>newBox</i> on mouseup using <i>x1, y1, x2, y2</i>.
	 ...
	 * @return false (desirable) if the specified box does not overlap with any children; true (undesirable) otherwise.
	 */
